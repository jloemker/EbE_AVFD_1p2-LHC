...
CSHEN======parameters declearation end===========================================
      ...
      do 3007 J=NYPhy0,NYPhy
       ...
       write(IWrite,3008)OTemp, Vx(I,J,K), Vy(I,J,K)
c      write(IWrite,3008)ITime-1, (I-NXPhy0), (J-NYPhy0),
c     &                OEd, OPL, OTemp, R_qgp, Vx(I,J,K), Vy(I,J,K),
c     &                OPi00, OPi01, OPi02, OPi11, OPi12,
c     &                OPi22, OPi33,OPPi,OEtas,OTaupi,OTaubPi	Yin
3007  continue
3008  FORMAT(3f18.8)
c3008  FORMAT(3i5,3f18.8,i5,13f18.8)	Yin
