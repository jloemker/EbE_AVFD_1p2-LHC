...
CSHEN===========================================================================
       Logical :: IOSCAR=.true.            ! trigger for output OSCAR format hydro results, False: not output, True: output Yin
...
c      if(IOSCAR) then
c            call OSCARheaderoutput(IOSCARWrite, NXPhy0, NXPhy,
c     &                             NYPhy0, NYPhy, T0, DX, DY)
c      endif						Yin
CSHEN======output OSCAR file Header end=====================================

CSHEN======set up output file for hydro evolution history===================
c     if(IhydroJetoutput .eq. 1) then
c        Call setHydroFiles(NX0, NX, DX, 4, NY0, NY, DY, 4, T0, DT, 5)
c     endif
C==Shuzhe commented these three line to avoid HDF5.
...
c     endif
C==Shuzhe commented these lines to avoid HDF5
CSHEN===========================================================================
...
5786     if(ITime .lt. ItimeOSCAR) then
         ITime =  ITime + 1
c         call OSCARredundantoutput(IOSCARWrite, NZ0, NZ, ITime,
c     &                             NXPhy0, NXPhy, NYPhy0, NYPhy)	Yin
         write(*,*) ITime
         goto 5786
         endif
      endif
