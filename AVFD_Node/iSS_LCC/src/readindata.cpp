...
/********* AVFD: density evolution and chemical potential combination here *********/
    double max_mu=AVFD_set_chemical_potential(surf_ptr, particle_ptr);
    cout << "Chemical Potential Assigned. The maximum value is " << max_mu << endl;
/********* AVFD density evolution and chemical potential combination ends *********/
}

void read_FOdata::read_decdat(std::vector<FO_surf> &surf_ptr) {
    double temp, temp_vx, temp_vy;
    cout <<" -- Read in information on freeze out surface..." << flush;
